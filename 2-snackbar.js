import{s as c}from"./assets/sprite-DztAg9nn.js";/* empty css                      */import{i as n}from"./assets/vendor-BbbuE1sJ.js";const r=document.querySelector(".form"),a=document.querySelector('input[name="delay"]'),m=document.querySelector('input[value="fulfilled"]');r.addEventListener("submit",d);function d(u){u.preventDefault();const i=a.value.replace(/[^\d]/g,"");new Promise((s,l)=>{m.checked?setTimeout(()=>{s(i)},i):setTimeout(()=>{l(i)},i)}).then(s=>{n.success({title:"OK",message:`Fulfilled promise in ${s}ms`,position:"topRight",backgroundColor:"#59a10d",titleColor:"#fff",messageColor:"#fff",icon:" ",close:!1,class:"custom-toast",onOpening:function(l,o){const t=o.querySelector(".iziToast-icon");t&&(t.innerHTML=`
